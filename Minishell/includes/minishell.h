...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/26 00:05:23 by mgirardi          #+#    #+#             */
/*   Updated: 2023/03/26 00:05:24 by mgirardi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_pulizia_vesuvio(t_env *sp);
void	ft_individua_partenopei(t_env *sp);
...
void	replace_with_thitler(char *stringa, int x);
